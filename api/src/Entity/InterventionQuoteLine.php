...
use App\Repository\InterventionQuoteLineRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Serializer\Annotation\Groups;

#[ORM\Entity(repositoryClass: InterventionQuoteLineRepository::class)]
#[ORM\Table(name: 'intervention_quote_lines')]
class InterventionQuoteLine
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(targetEntity: InterventionQuote::class, inversedBy: 'lines')]
    ...
    public function setQuote(?InterventionQuote $quote): static
    {
        $this->quote = $quote;
        return $this;
    }
