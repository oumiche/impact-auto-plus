 ...
 */
final class Version20251002014020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attachments CHANGE uploaded_by_id uploaded_by_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attachments CHANGE uploaded_by_id uploaded_by_id INT NOT NULL');
