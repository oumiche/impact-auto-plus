 ...
 */
final class Version20251008183912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE intervention_work_authorizations ADD CONSTRAINT FK_81D3EED42B62D3A1 FOREIGN KEY (authorized_by_id) REFERENCES collaborateurs (id)');
        $this->addSql('ALTER TABLE models ADD CONSTRAINT FK_E4D6300944F5D008 FOREIGN KEY (brand_id) REFERENCES brands (id)');
        $this->addSql('ALTER TABLE reports ADD CONSTRAINT FK_F11FA7459033212A FOREIGN KEY (tenant_id) REFERENCES tenants (id)');
        ...
        $this->addSql('ALTER TABLE supply_price_history CHANGE vehicle_brand_id vehicle_brand_id INT DEFAULT NULL, CHANGE vehicle_model_id vehicle_model_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE supply_price_history ADD CONSTRAINT FK_581CE9BAFF28C0D8 FOREIGN KEY (supply_id) REFERENCES supplies (id)');
        $this->addSql('ALTER TABLE supply_price_history ADD CONSTRAINT FK_581CE9BA545317D1 FOREIGN KEY (vehicle_id) REFERENCES vehicles (id)');
        $this->addSql('ALTER TABLE supply_price_history ADD CONSTRAINT FK_581CE9BA99E7DF9C FOREIGN KEY (vehicle_brand_id) REFERENCES brands (id)');
        $this->addSql('ALTER TABLE supply_price_history ADD CONSTRAINT FK_581CE9BAA467B873 FOREIGN KEY (vehicle_model_id) REFERENCES models (id)');
        $this->addSql('ALTER TABLE supply_price_history ADD CONSTRAINT FK_581CE9BAA762F68 FOREIGN KEY (work_authorization_id) REFERENCES intervention_work_authorizations (id)');
        $this->addSql('ALTER TABLE supply_price_history ADD CONSTRAINT FK_581CE9BA8EAE3863 FOREIGN KEY (intervention_id) REFERENCES vehicle_interventions (id)');
        $this->addSql('ALTER TABLE supply_price_history ADD CONSTRAINT FK_581CE9BAB03A8386 FOREIGN KEY (created_by_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE supply_price_history ADD CONSTRAINT FK_581CE9BA896DBBDE FOREIGN KEY (updated_by_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE intervention_work_authorizations DROP FOREIGN KEY FK_81D3EED42B62D3A1');
        $this->addSql('ALTER TABLE models DROP FOREIGN KEY FK_E4D6300944F5D008');
        $this->addSql('ALTER TABLE reports DROP FOREIGN KEY FK_F11FA7459033212A');
        ...
        $this->addSql('ALTER TABLE supply_price_history DROP FOREIGN KEY FK_581CE9BAFF28C0D8');
        $this->addSql('ALTER TABLE supply_price_history DROP FOREIGN KEY FK_581CE9BA545317D1');
        $this->addSql('ALTER TABLE supply_price_history DROP FOREIGN KEY FK_581CE9BA99E7DF9C');
        $this->addSql('ALTER TABLE supply_price_history DROP FOREIGN KEY FK_581CE9BAA467B873');
        $this->addSql('ALTER TABLE supply_price_history DROP FOREIGN KEY FK_581CE9BAA762F68');
        $this->addSql('ALTER TABLE supply_price_history DROP FOREIGN KEY FK_581CE9BA8EAE3863');
        $this->addSql('ALTER TABLE supply_price_history DROP FOREIGN KEY FK_581CE9BAB03A8386');
        $this->addSql('ALTER TABLE supply_price_history DROP FOREIGN KEY FK_581CE9BA896DBBDE');
        $this->addSql('ALTER TABLE supply_price_history CHANGE vehicle_brand_id vehicle_brand_id INT NOT NULL, CHANGE vehicle_model_id vehicle_model_id INT NOT NULL');
