 ...
 */
final class Version20251008170636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX idx_tenant ON supply_price_history');
        $this->addSql('ALTER TABLE supply_price_history DROP tenant_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE supply_price_history ADD tenant_id INT NOT NULL');
        $this->addSql('CREATE INDEX idx_tenant ON supply_price_history (tenant_id)');
