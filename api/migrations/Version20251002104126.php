 ...
 */
final class Version20251002104126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE intervention_quote_lines DROP description, CHANGE supply_id supply_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE intervention_quotes ADD garage_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_4B15AAE0C4FFF555 ON intervention_quotes (garage_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE intervention_quote_lines ADD description LONGTEXT NOT NULL, CHANGE supply_id supply_id INT DEFAULT NULL');
        ...
        $this->addSql('DROP INDEX IDX_4B15AAE0C4FFF555 ON intervention_quotes');
        $this->addSql('ALTER TABLE intervention_quotes DROP garage_id');
